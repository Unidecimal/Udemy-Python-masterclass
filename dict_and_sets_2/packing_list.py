...
if mode == "2":
    ...
    #     # below row will crash the program. That is because of it is
    #     # trying to remove item that is not in the set. remove crash when items
    #     # don't exist.
    #     items.discard(restricted_item)

    # Using set functions and operators
